...
const Footer = ({ toogleColorMode }) => {
    
    
    return (
        <Flex align='center' fontWeight='bolder' position='fixed' bottom='0' zIndex='1' backgroundColor='#676767' width='100%' boxShadow='dark-lg' p='2' mb='2' >


            <Spacer />
            <Box p='2' fontSize='10px' display='flex' size='sm' alignItems='center' justifyContent='center' >
                @Follow Me - {toogleColorMode}
